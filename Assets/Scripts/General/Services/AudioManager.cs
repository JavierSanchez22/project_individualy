...
public class AudioManager : MonoBehaviour {
	...
	private void OnEnable() => GameEvents.OnUpdateVolume += (track, volume) => ChangeTrackVolume(track, volume);

	private void OnDisable() => GameEvents.OnUpdateVolume -= (track, volume) => ChangeTrackVolume(track, volume);
